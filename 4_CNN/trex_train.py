...
def onehot_labels(values):
    ...
    onehot_encod = onehot_encoder.fit_transform(integer_encoded)
    return onehot_encod
...
print("eğitim Dogruluk: %",score_train[1]*100)

score_test = model.evaluate(test_X,test_Y)
print("Test Dogruluk: %",score_test[1]*100)
